package com.easytoolsoft.template.web.springmvc2.config.jersey;

import javax.annotation.PostConstruct;

import com.easytoolsoft.template.web.springmvc2.rest.v1.EventResource;
...
public class JerseyConfig extends ResourceConfig {
    ...
    private void registerEndpoints() {
        ...
        this.register(com.easytoolsoft.template.web.springmvc2.rest.v2.EventResource.class);
