package com.easytoolsoft.template.web.jersey.config.datasource;
...
public class DataSourceConfig {
    ...
    @Value("${web.jersey.datasource.member.type}")
    private Class<? extends DataSource> dataSourceType;

    @ConfigurationProperties(prefix = "web.jersey.datasource")
