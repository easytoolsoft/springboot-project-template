package com.easytoolsoft.template.web.springmvc2.rest.v2;
...
public class EventResource {
    ...
    @GET
    @Path("event/{id}")
    @Consumes("application/vnd.springboot-template-v2+json")
    @Produces("application/vnd.springboot-template-v2+json")
